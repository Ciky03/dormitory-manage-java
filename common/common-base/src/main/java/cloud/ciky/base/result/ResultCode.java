package cloud.ciky.base.result;
...
public enum ResultCode implements IResultCode, Serializable {
    ...
    USER_ACCOUNT_INVALID("A0203", "用户已禁用"),
    USER_ACCOUNT_OTHER_SITE_LOGIN("A0204", "用户账户异地登录"),
    USER_LOGOUT_AUTHORIZATION_ERROR("A0205", "用户登录授权异常"),
    ...
    REFRESH_TOKEN_INVALID("A0232","refresh token无效或已过期"),
    ...
    SYSTEM_OPERATION_DISABLED("B0002", "操作不被允许"),
    ...
    SERVICE_UNAVAILABLE("B0230", "服务不可达"),
