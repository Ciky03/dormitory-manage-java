package cloud.ciky.security.service;
...
public class PermissionService {
    ...
    public Set<String> getDeptPermsFormCache(String deptId) {
        ...
        Set<String> perms = new HashSet<>();
        // 从缓存中获取部门的权限
        Object rolePermsObj = redisTemplate.opsForHash().get(RedisConstants.System.DEPT_PERMS, deptId);
        if (rolePermsObj instanceof Set) {
            @SuppressWarnings("unchecked")
            Set<String> rolePerms = (Set<String>) rolePermsObj;
            perms.addAll(rolePerms);
