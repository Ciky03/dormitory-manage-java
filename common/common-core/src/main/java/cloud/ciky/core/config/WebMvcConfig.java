package cloud.ciky.core.config;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        objectMapper.setDateFormat(new SimpleDateFormat(DateFormatConstants.FORMAT1));
    ...
    private static class DecimalSerializer extends JsonSerializer<BigDecimal> {
        @Override
